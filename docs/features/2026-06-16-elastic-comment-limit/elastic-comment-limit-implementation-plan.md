...
- **무엇이**: `ulssu_backend/main.py:8` (load_dotenv 추가, database import 전), `pyproject.toml`/`uv.lock`(python-dotenv 의존성), 삭제: `battle_arena.py`·`battle_arena_v2.py`·루트 `main.py`
